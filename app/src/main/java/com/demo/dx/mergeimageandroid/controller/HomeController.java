...
////        controlUser.setAttribute(3, httpClient.getServerToken());
//        controlModel.updateUserDB(controlUser);
//    }
...
//            //  @Override
//            public void run() {
//                JSONObject jsonObject = controlModel.getFunctionListJson();
//                if (jsonObject != null) {
//                    String insertFunctionListUrl = StringProcess.getJavascriptFunctionStringByJson(jsonObject, Constants.FUNCTION_LIST, Constants.INSERT_FUNCTION_LIST_JAVASCRIPT);
//                    mainWebView.loadUrl(insertFunctionListUrl);
//                }
//            }
//        });
//    }
