...
public class AboutController extends Controller{
    ...
    public AboutController(Activity activity, WebView webView, JavaScriptInterface javaScriptInterface, String pageName) {
...
//                insertLanguage();
    ...
    private void updateWebView() {
        ...
        mainWebView.loadUrl(Constants.ABOUT_WEB_URL);
